...
Output:
  my_results_per_well_efficiency.csv
...
def main() -> int:
    ...
    ap.add_argument("--efficiency-mode", choices=["rdml_like", "target_mean", "per_well", "sample_target_mean"], default="rdml_like", help="Default: rdml_like. Use sample_target_mean to calculate E separately for each sample x target.")
    ...
    args = ap.parse_args()
    print("Script version: linregpcr_strict_window_multiinput_target_casefix_minimal_rstats_2026-06-12")
    ...
    if args.write_intermediate:
        ...
        eff_fields = [
            "Dataset", "Amp_File", "Cq_File", "Well", "status", "E_amp_factor", "Efficiency_percent", "r2", "slope", "intercept",
